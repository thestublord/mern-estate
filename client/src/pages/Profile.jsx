...
export default function Profile() {
  ...
  const [shoowListingsError, setShowListingsError] = useState(false);
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-700 ">
              Error Image upload (max size 2mb)
            </span>
      ...
      <button onClick={handleShowLisings} className="text-green-700 w-full">
        Show Listings
      </button>
      <p className="text-red-700 mt-5">
        {shoowListingsError ? "Error showing listings" : ""}
      </p>
            ...
            >
              <Link to={`/listing/${listing._id}`}>
                <img
                  ...
                  alt="listing cover"
                  className="h-16 w-16 object-contains"
                />
              </Link>
              <Link
